...
namespace hfox{
  ...
  void Cubature::initializeDatabase(){
    ...
    tempCoords[2] = std::vector<double>(1, 0.8360311073266358);
    tempCoords[3] = std::vector<double>(1, -0.9681602395076261);
    tempCoords[4] = std::vector<double>(1, 0.9681602395076261);
    tempCoords[5] = std::vector<double>(1, -0.3242534234038089);
    tempCoords[6] = std::vector<double>(1, 0.3242534234038089);
    tempCoords[7] = std::vector<double>(1, -0.6133714327005904);
    tempCoords[8] = std::vector<double>(1, 0.6133714327005904);
